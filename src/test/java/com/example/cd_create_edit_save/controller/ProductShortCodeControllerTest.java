...
public class ProductShortCodeControllerTest {
	...
	public void testGetAllProductShortCodes() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/api/products/product-short-codes")
	...
	public void testGetAllProductShortCodesEmptyList() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/api/products/product-short-codes").accept(MediaType.APPLICATION_JSON))
