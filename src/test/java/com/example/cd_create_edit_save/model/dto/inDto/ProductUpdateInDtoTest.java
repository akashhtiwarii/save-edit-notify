...
/**
 * Unit tests for ProductUpdateInDto validation
...
class ProductUpdateInDtoTest {
    ...
    private ProductUpdateInDto createValidDto() {
    ...
    void testValidDto() {
        ProductUpdateInDto dto = createValidDto();
        Set<ConstraintViolation<ProductUpdateInDto>> violations = validator.validate(dto);
