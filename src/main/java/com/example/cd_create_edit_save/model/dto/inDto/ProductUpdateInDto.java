 ...
 *
 * <p>This class defines all input fields required for product update operations,
 * along with validation rules to ensure valid and consistent data.</p>
 *
 * <p>It is typically used in {@code PUT} requests to the product API.</p>
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
