...
public final class AppConstants {
	...
	public static final String ANNUAL_FEE_VALUES = "/annual-fee-values";
	public static final String API_ANNUAL_FEE_VALUES= PRODUCT_API_BASE_PATH + ANNUAL_FEE_VALUES;
